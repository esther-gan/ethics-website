...
<table>
    <tr>
        <td><img src="https://i.imgur.com/KHlXORt.jpeg" alt="David Ifeoluwa Adelani" class="portrait"></td>
        <td>
    ...
    <tr>
        <td><img src="https://i.imgur.com/UTOb633.jpeg" alt="Adriana Silvina Pagano" class="portrait"></td>
        <td>
...
<table>
    <tr>
        <td><img src="https://i.imgur.com/MBamZKK.jpeg" alt="Fanny Ducel" class="portrait"></td>
        <td>
    ...
    <tr>
        <td><img src="https://i.imgur.com/tmODwaO.jpeg" alt="Guido Ivetta" class="portrait"></td>
        <td>
